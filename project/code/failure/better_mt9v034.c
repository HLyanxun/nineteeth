...
//{
//    tft180_show_gray_image(0, 0, mt9v03x_image[0],MT9V03X_W, MT9V03X_H, MT9V03X_W/2, MT9V03X_H/2,binaryzation_value);
//}
//
////----------------------------------------------------------------------------------------------------------------------
//// 函数简介     通过大津法计算二值化阈值
...
//// 参数说明     rank  多项式的次数
//// 参数说明     coeff 输出的系数
//// 备注信息    float占用8字节，float占用4字节，可以考虑优化
////-------------------------------------------------------------------------------------------------------------------------------
...
//
//    int i,j,k;
//    float aT_A[RANK_ + 1][RANK_ + 1] = {0};
//    float aT_Y[RANK_ + 1] = {0};
//
//
...
//    {
//        int row = k;
//        float mainElement = fabs(aT_A[k][k]);
//        float temp = 0.0;
//
//        //找主元素
...
//{
//    int8 lostleft,lostright;
//    lostleft=lost_line_left;
//    lostright=lost_line_right;
//    if(ex_crossroad_flag==1)//如果已经进入十字路口
//    {
//        switch(ex_crossroad_state)//十字路口状态判断
//        {
//        case 1:
//            if(lostleft==-1 && lostright==-1)ex_crossroad_state=2;//进入十字路口弯道
//            break;
//        case 2:
//            if(lostleft!=-1 && lostright!=-1)ex_crossroad_state=3;//出十字路口
//            break;
//        case 3:
//            if(lostleft==-1 && lostright==-1){ex_crossroad_state=0;ex_crossroad_flag=0;}//清除标志位
//            break;
//        }
...
//    lostleft=lost_line_left;
//    lostright=lost_line_right;
//    if(lostleft!=-1 || lostright!=-1)//进入元素识别
//    {
//        if(lostleft!=-1 && lostright==-1)//左环岛判断
//        {
...
//            }
//        }
//        if(lostleft==-1 && lostright!=-1)//右环岛判断
//        {
...
//            break;
//        case 3:
//            if(lostleft!=-1)//如果左边第二次丢线，找拐点补线进入环岛
//            {
